...
export const finishings: string[] = [
  'Sem acabamento',
  'Ilhós',
  'Bastão + corda',
  'Dobrado',
...
export const priorities: string[] = ['Baixa', 'Média', 'Alta', 'Urgente']

export const roles: string[] = ['Administrador', 'Financeiro', 'Produção', 'Vendas', 'Funcionário']
