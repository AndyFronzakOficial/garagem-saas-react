  ...
  async function save(e:React.FormEvent){
    ...
    try{
      ...
      const {error}=await supabase.from('public_quotes').insert({
        ...
        auto_estimated_price:autoTotal,
        manual_price:manualTotal > 0 ? manualTotal : null,
    ...
    <div className="client-portal">
      <div className="client-shell">
        <section className="client-card">
          ...
          <p className="text-zinc-400">Informe as medidas em centímetros. Exemplo: 120 x 80.</p>
          ...
          <form onSubmit={save} className="client-grid mt-6">
            ...
            <input
              className="input full"
              placeholder="Valor manual opcional. Ex: 250,00"
              value={f.manual_price}
              onChange={e=>setF({...f,manual_price:e.target.value})}
            />
            ...
            <div className="price-preview full">
              ...
              <div className="text-sm text-zinc-400">Valor automático: {money(autoTotal)}</div>
              {manualTotal > 0 && <div className="text-sm text-gold">Valor manual aplicado</div>}
