...
export default function Settings(){
  ...
  async function load(){
    ...
    if(data) setF({
      ...
      cash_opening_date:data.cash_opening_date || ''
    })
  ...
  async function save(e:React.FormEvent){
    ...
    const month = currentMonth()
    const payload = {...f, logo_url:logoUrl, monthly_goal:goalValue, cash_opening_balance:brNumber(f.cash_opening_balance), cash_opening_date:f.cash_opening_date || null}
